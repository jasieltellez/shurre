...
function shurre_scripts() {
	...
	wp_enqueue_style( 'shurre-style-materialize', get_template_directory_uri() . '/css/materialize.min.css');

	wp_enqueue_script( 'shurre-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'shurre-navigation-jquery', get_template_directory_uri() . '/js/jquery.js', array(), '20151215', true );
	wp_enqueue_script( 'shurre-navigation-materialize', get_template_directory_uri() . '/js/materialize.min.js', array(), '20151215', true );
